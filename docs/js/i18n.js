...
const translations = {
    zh: {
        ...
        btn_share: "🔗 分享這個網站",
        footer: "© 2026 Hermès Ethical Petition | 開源倡議 | Powered by 龍蝦姬 🦞",
        supported: "✅ 已支持",
    ...
    en: {
        ...
        footer: "© 2026 Hermès Ethical Petition | Open Source Initiative | Powered by 龍蝦姬 🦞",
        supported: "✅ Supported",
    ...
    fr: {
        ...
        footer: "© 2026 Pétition Éthique Hermès | Initiative Open Source | Propulsé par 龍蝦姬 🦞",
        supported: "✅ Soutenu",
    ...
    ja: {
        ...
        btn_share: "🔗 このサイトをシェア",
        footer: "© 2026 エルメス倫理的嘆願 | オープンソースイニシアチブ | Powered by 龍蝦姬 🦞",
        supported: "✅ 支持済み",
    ...
    ko: {
        ...
        btn_share: "🔗 사이트 공유하기",
        footer: "© 2026 에르메스 윤리적 청원 | 오픈소스 이니셔티브 | Powered by 龍蝦姬 🦞",
        supported: "✅ 지원됨",
